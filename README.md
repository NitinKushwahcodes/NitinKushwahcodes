...
const nitin = {
  ...
  goal      : "SDE Internship + meaningful open source contributions",
  contact   : "nitin.kushwah.cs@gmail.com"
};
```
...
A production-deployed full stack app — complete frontend + backend.

- JWT authentication with role-based access control (3 roles)
- 15+ REST API endpoints with filtering, pagination & sorting
- Security layer: Helmet, bcrypt, rate limiting, CORS
...
### AI Interview Assistant *(In Development)*
![React](https://img.shields.io/badge/React-20232A?style=flat&logo=react&logoColor=61DAFB)
![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat&logo=node.js&logoColor=white)
![OpenAI](https://img.shields.io/badge/OpenAI-412991?style=flat&logo=openai&logoColor=white)
![Puppeteer](https://img.shields.io/badge/Puppeteer-40B5A4?style=flat&logo=puppeteer&logoColor=white)

Full stack MERN app integrating LLMs for structured interview feedback.

- GPT/Gemini integration via custom backend pipeline
- Automated PDF report generation using Puppeteer (< 2s)
- Zod schema validation across all routes, Multer file uploads
...
### IndiaQuant MCP — Stock Intelligence Backend
![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat&logo=node.js&logoColor=white)
![SQLite](https://img.shields.io/badge/SQLite-003B57?style=flat&logo=sqlite&logoColor=white)
![Express](https://img.shields.io/badge/Express-404D59?style=flat&logo=express)

Backend-only quant system — no UI, pure logic and performance.

- Real-time NSE/BSE data via 3+ financial APIs (sub-second response)
- RSI-based trading signal engine + NLP sentiment on financial news
- Black-Scholes options Greeks: Delta, Gamma, Theta, Vega
...
→ Exploring backend infra & deployment
...
![OS](https://img.shields.io/badge/Operating_Systems-555555?style=for-the-badge)
![DBMS](https://img.shields.io/badge/DBMS-47A248?style=for-the-badge)
![CN](https://img.shields.io/badge/Computer_Networks-0077B5?style=for-the-badge)
...
<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=NitinKushwahcodes&theme=tokyo-night&hide_border=true&area=true"/>
</div>
...
*Currently learning. Currently building. Open to work.*
